...
class RenderJob:
    ...
    process: Optional[Popen] = field(default=None, init=False, repr=False)
    log_lines: list[str] = field(default_factory=list, init=False, repr=False)
    _detected_device: Optional[str] = field(default=None, init=False, repr=False)
    _is_paused: bool = field(default=False, init=False, repr=False)
